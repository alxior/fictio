    ...
    <div className="w-full overflow-hidden font-poppins mt-16">
      <div className="container mx-auto px-4">
        ...
        <div className="grid space-y-16 xl:space-y-0 lg:grid-cols-5 lg:grid-rows-2 xl:grid-rows-5">
          <div className="text-center self-center xl:self-auto lg:text-left lg:col-span-2 lg:pt-20 xl:row-span-3">
          ...
          <Image
            src={heroPicture}
            alt="hero"
            className="px-4 lg:col-span-3 xl:row-span-5 xl:self-center lg:px-0 xl:pl-16 xl:pb-16"
          />
          <p className="lg:col-span-5 xl:col-span-2 lg:px-32 text-center font-poppins text-[20px] md:text-[24px] xl:p-0 xl:pt-4 xl:text-left xl:text-[20px] xl:row-span-2 text-darkGray">
        ...
        {/* <div className="flex flex-row py-24 mt-4">
          <div className="w-2/5">
